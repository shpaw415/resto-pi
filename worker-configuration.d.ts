/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1a0631f54b6309574d561d81c6b668ee)
...
interface __BaseEnv_Env {
	...
	PUBLIC_LIVE_ORIGIN: "http://127.0.0.1:8788";
	NODE_ENV: string;
	...
	AUTH_SECRET: string;
	COLOSSAL_API_KEY: string;
	COLOSSAL_BASE_URL: string;
	COLOSSAL_LOCATION_ID: string;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BUN_VERSION" | "SKIP_DEPENDENCY_INSTALL" | "PUBLIC_LIVE_ORIGIN" | "NODE_ENV" | "WRANGLER_PORT" | "PUBLIC_AUTH_CLIENT_ID" | "PUBLIC_AUTH_ISSUER" | "PUBLIC_AUTH_REDIRECT_URI" | "AUTH_SECRET" | "COLOSSAL_API_KEY" | "COLOSSAL_BASE_URL" | "COLOSSAL_LOCATION_ID">> {}
}
